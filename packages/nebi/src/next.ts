...
export function createNebiRouteHandler(options: NebiRouteOptions = {}) {
  ...
  return async function POST(request: Request): Promise<Response> {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : "Nebi request failed.";
